...
namespace GalleryServerPro.Web.Controller
{
	...
	public static class GalleryObjectController
	{
		...
		/// <remarks>When no user name is available through Util.UserName, the string &lt;unknown&gt; is
		...
		{
			string userName = (String.IsNullOrEmpty(Util.UserName) ? Resources.GalleryServerPro.Site_Missing_Data_Text : Util.UserName);
