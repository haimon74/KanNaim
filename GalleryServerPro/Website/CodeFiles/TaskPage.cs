...
namespace GalleryServerPro.Web.Pages
{
	...
	public class TaskPage : Pages.GalleryPage
	{
		...
		/// <summary>
		/// Gets or sets the location for the <see cref="Controls.task.taskheader"/> user control. Classes that inherit 
		...
		/// </summary>
		/// <value>The <see cref="Controls.task.taskheader"/> user control.</value>
		...
		/// page title and the top Save/Cancel buttons. (The bottom Save/Cancel buttons are in the <see cref="Controls.task.taskfooter"/> user control.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the location for the <see cref="Controls.task.taskfooter"/> user control. Classes that inherit 
		/// <see cref="Pages.TaskPage"/> should set this property to the <see cref="PlaceHolder"/> that is to contain
		/// the task footer control. If this property is not assigned by the inheriting class, the task footer control
		/// is not added to the page output.
		/// </summary>
		/// <value>The <see cref="Controls.task.taskfooter"/> user control.</value>
