...
namespace GalleryServerPro.Web.gs.pages.task
{
	public partial class addobjects : Pages.TaskPage
	{
		...
		private void ConfigureControlsFirstTime()
		{
			...
			if (Core.DiscardOriginalImageDuringImport)
			{
		...
		private void ConfigureTabStrip()
		{
			...
			bool allowLocalContent = Core.AllowAddLocalContent;
			bool allowExternalContent = Core.AllowAddExternalContent;
		...
		private void AddPopupInfoItems()
		{
			...
			int maxUploadSize = Core.MaxUploadSize;
...
",
			...
			upload.MaximumUploadSize = Core.MaxUploadSize;
...
",
		...
		private bool AddExternalHtmlContent()
		{
			...
			mediaObject.Title = Util.CleanHtmlTags(title);
