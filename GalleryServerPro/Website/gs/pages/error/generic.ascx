<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="generic.ascx.cs" Inherits="GalleryServerPro.Web.gs.pages.error.generic" %>
<style type="text/css">
	img { border: none; }
	body {font: 12px Verdana, Arial, Helvetica, sans-serif;}
	.gsp_msgwarning { color: #c03; }
	div#gsp_errContainer { margin: 25px auto auto auto; width: 800px; height: 500px; border: 3px solid #61002B;-moz-border-radius:10px;-webkit-border-radius:10px; }
	div#gsp_errContainer div#gsp_errHeader { height: 75px; background-color: #ECF1F6; border-bottom: 1px solid #61002B; position: relative;-moz-border-radius:6px 6px 0 0;-webkit-border-top-right-radius:6px;-webkit-border-top-left-radius:6px; }
