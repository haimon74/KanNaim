<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="backuprestore.ascx.cs" Inherits="GalleryServerPro.Web.gs.pages.admin.backuprestore" %>
...
(new Image()).src = "<%= Util.GalleryRoot %>/images/spinner.gif";
	...
	<div class="gsp_addpadding1">
		...
		<ComponentArt:TabStrip ID="tsBackupRestore" MultiPageId="mpBackupRestore" TopGroupCssClass="ts0TopGroup" DefaultSelectedItemLookId="SelectedTab"
			...
			<ItemLooks>
				<ComponentArt:ItemLook LookId="DefaultTab" CssClass="ts0DefaultTab" HoverCssClass="ts0DefaultTabHover" LabelPaddingLeft="10" LabelPaddingRight="17"
					LabelPaddingTop="2" LabelPaddingBottom="6" />
				<ComponentArt:ItemLook LookId="SelectedTab" CssClass="ts0SelectedTab" LabelPaddingLeft="10" LabelPaddingRight="17" LabelPaddingTop="2"
		...
		<ComponentArt:MultiPage ID="mpBackupRestore" CssClass="mp2MultiPage" runat="server">
			...
			<ComponentArt:PageView ID="PageView2" CssClass="mp2MultiPageContent" runat="server" Height="300">
				<p class="gsp_h3">
				...
				<asp:Panel ID="pnlRestoreFileInfo" runat="server" Visible="true">
					<table id="restoreFileContainer" class="gsp_rounded10" cellpadding="0" cellspacing="0">
						<tr class="gsp_tableSummaryRow gsp_roundedtop6">
							<td colspan="3">
								<p>
									<asp:LinkButton ID="lbRemoveRestoreFile" runat="server" Text="Remove" CssClass="gsp_fs" Visible="false" OnClick="lbRemoveRestoreFile_Click" />
		...
		<ComponentArt:Dialog ID="UploadDialog" runat="server" Visible="false" AllowDrag="true" AllowResize="false" Modal="true" Alignment="MiddleCentre" Width="658"
			Height="347" ContentCssClass="dlg-up" ContentClientTemplateId="UploadContent" CssClass="gsp_ns" />
	</div>
