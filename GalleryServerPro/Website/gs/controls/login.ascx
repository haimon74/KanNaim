	...
	<asp:LoginView ID="lv" runat="server" EnableViewState="false">
		<LoggedInTemplate>
			<p class="loggedonview gsp_useroption">
				...
				<asp:LoginStatus ID="LoginStatus1" runat="server" LogoutImageUrl="<%= Util.GalleryRoot %>/images/user_48x48.png" EnableViewState="false" OnLoggedOut="LoginStatus1_LoggedOut"
			...
			<ComponentArt:Dialog ID="dgLogin" runat="server" CloseTransition="Fade" ShowTransition="Fade"
				...
				<ContentTemplate>
					<p class="gsp_textright">
						<img onclick="dgLogin.Close('cancelled');" src="<%= Util.GalleryRoot %>/images/componentart/dialog/close.gif"
							alt="Close" /></p>
