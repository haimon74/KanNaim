...
namespace GalleryServerPro.Web.handler
{
	...
	public class getmediaobject : IHttpHandler, IReadOnlySessionState
	{
		...
		private static Bitmap GetDefaultThumbnailBitmap()
		{
			...
			Color bgColor = HelperFunctions.GetColor(coreConfig.EmptyAlbumThumbnailBackgroundColor);
			Color fontColor = HelperFunctions.GetColor(coreConfig.EmptyAlbumThumbnailFontColor);
