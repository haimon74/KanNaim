/*
SQL SERVER 2005 and later: This script updates the database schema from 2.1.3162 to 2.3.3421.
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorSelect]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[gs_AppErrorSelect]
GO
/****** Object:  StoredProcedure [dbo].[gs_AppErrorInsert] ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorInsert]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[gs_AppErrorInsert]
GO
/****** Object:  StoredProcedure [dbo].[gs_AppErrorDelete] ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorDelete]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[gs_AppErrorDelete]
GO
/****** Object:  StoredProcedure [dbo].[gs_AppErrorDeleteAll] ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorDeleteAll]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[gs_AppErrorDeleteAll]
GO

IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppError]') AND type in (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_gs_AppError_gs_Gallery]') AND parent_object_id = OBJECT_ID(N'[dbo].[gs_AppError]'))
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppError]') AND name = N'IDX_gs_AppError_FKGalleryId')
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorInsert]') AND type in (N'P', N'PC'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorSelect]') AND type in (N'P', N'PC'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorDelete]') AND type in (N'P', N'PC'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[gs_AppErrorDeleteAll]') AND type in (N'P', N'PC'))
BEGIN
...
IF  EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[gs_Album]') AND name = N'IDX_gs_Album_AlbumParentId')
DROP INDEX [IDX_gs_Album_AlbumParentId] ON [dbo].[gs_Album]
GO

/* Step 5. Create the index IDX_gs_Album_AlbumParentId_FKGalleryId. */
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[gs_Album]') AND name = N'IDX_gs_Album_AlbumParentId_FKGalleryId')
...
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[gs_InitializeGalleryServerPro]') AND xtype in (N'P', N'PC'))
