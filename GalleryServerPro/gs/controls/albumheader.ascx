...
<asp:Panel ID="pnlAlbumHeader" runat="server" CssClass="albumHeaderReadOnly">
	<div class="gsp_albumdetail">
		...
		<p id="pADC" runat="server" class="gsp_useroption gsp_downloadzip"><a href='<%= Util.GetUrl(PageId.task_downloadobjects, "aid={0}", GalleryPage.AlbumId) %>' class=""><img src="<%= Util.GalleryRoot %>/images/downloadzip.png" style="width:32px;height:32px;" alt='<asp:Literal
