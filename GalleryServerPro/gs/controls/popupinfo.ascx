...
<ComponentArt:Dialog ID="dgPopup" OffsetX="10" OffsetY="10" AlignmentElement="" HeaderCssClass="dg5HeaderCss"
	...
	<Header>
		<img src='<%= Util.GetUrl("/images/componentart/dialog/popup/top.gif") %>' alt="" style="display: block;width: 303px;
			height: 25px;" />
	</Header>
	<Footer>
		<img src='<%= Util.GetUrl("/images/componentart/dialog/popup/bottom.gif") %>' style="display: block;width: 303px; height: 6px;" alt="" />
	</Footer>
</ComponentArt:Dialog>
