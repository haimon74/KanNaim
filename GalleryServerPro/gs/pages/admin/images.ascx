<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="images.ascx.cs" Inherits="GalleryServerPro.Web.gs.pages.admin.images" %>
...
<div class="gsp_indentedContent">
	...
	<tis:wwDataBinder ID="wwDataBinder" runat="server">
		<DataBindingItems>
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem5b" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem12" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem13" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem15" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem16" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem17" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem18" runat="server" BindingProperty="SelectedValue"
				BindingSource="CoreConfig" BindingSourceMember="WatermarkImageLocation" ControlId="ddlWmkImageLocation"
				UserFieldName="<%$ Resources:GalleryServerPro, Admin_Images_WmkImageLocation_Label %>" />
		</DataBindingItems>
	</tis:wwDataBinder>
