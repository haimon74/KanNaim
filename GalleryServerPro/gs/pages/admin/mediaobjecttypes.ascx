<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="mediaobjecttypes.ascx.cs"
	Inherits="GalleryServerPro.Web.gs.pages.admin.mediaobjecttypes" %>
...
<div class="gsp_indentedContent">
	...
	<tis:wwDataBinder ID="wwDataBinder" runat="server">
		<DataBindingItems>
			<tis:wwDataBindingItem ID="wbi1" runat="server" BindingSource="CoreConfig" BindingSourceMember="AllowUnspecifiedMimeTypes"
