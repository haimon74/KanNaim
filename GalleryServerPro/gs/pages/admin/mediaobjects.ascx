<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="mediaobjects.ascx.cs"
	Inherits="GalleryServerPro.Web.gs.pages.admin.mediaobjects" %>
...
<div id="d1" runat="server">
	...
	<script type="text/javascript">
		...
		function chkEnableMetadata_Click()
		{
			configControls();
		}
		...
		function configControls()
		{
			...
			var chkEnableMetadata = $get('<%= chkEnableMetadata.ClientID %>');
			$get('<%= chkEnableWpfMetadataExtraction.ClientID %>').disabled = (!chkEnableMetadata.checked || chkEnableMetadata.disabled);
		}
...
<div class="gsp_indentedContent">
	...
	<div class="gsp_addpadding1">
		...
		<p class="gsp_addtopmargin5">
			<asp:CheckBox ID="chkEnableMetadata" runat="server" onclick="chkEnableMetadata_Click()"
				Text="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableMetadata_Label %>" />
		</p>
		<p class="gsp_addleftmargin5">
			<asp:CheckBox ID="chkEnableWpfMetadataExtraction" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableWpfMetadataExtraction_Label %>" />
		</p>
		<p class="gsp_addtopmargin5">
		...
		<p class="gsp_addtopmargin5">
			<asp:CheckBox ID="chkEnableMoZipDownload" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableMoZipDownload_Label %>" />
		</p>
		<p class="gsp_addtopmargin5">
	...
	<tis:wwDataBinder ID="wwDataBinder" runat="server" OnValidateControl="wwDataBinder_ValidateControl"
		...
		<DataBindingItems>
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem1d" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem1b" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem3" runat="server" BindingSource="CoreConfig"
				...
				IsRequired="false" />
			<tis:wwDataBindingItem ID="WwDataBindingItem9b" runat="server" BindingSource="CoreConfig"
				BindingSourceMember="EnableImageMetadata" ControlId="chkEnableMetadata" BindingProperty="Checked"
				UserFieldName="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableMetadata_Label %>" />
			<tis:wwDataBindingItem ID="WwDataBindingItem9c" runat="server" BindingSource="CoreConfig"
				BindingSourceMember="EnableWpfMetadataExtraction" ControlId="chkEnableWpfMetadataExtraction"
				BindingProperty="Checked" UserFieldName="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableWpfMetadataExtraction_Label %>" />
			<tis:wwDataBindingItem ID="WwDataBindingItem9d" runat="server" BindingSource="CoreConfig"
				BindingSourceMember="EnableMediaObjectDownload" ControlId="chkEnableMoDownload"
				BindingProperty="Checked" UserFieldName="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableWpfMetadataExtraction_Label %>" />
			<tis:wwDataBindingItem ID="WwDataBindingItem9e" runat="server" BindingSource="CoreConfig"
				BindingSourceMember="EnableMediaObjectZipDownload" ControlId="chkEnableMoZipDownload"
				BindingProperty="Checked" UserFieldName="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableWpfMetadataExtraction_Label %>" />
			<tis:wwDataBindingItem ID="WwDataBindingItem9f" runat="server" BindingSource="CoreConfig"
				BindingSourceMember="EnablePermalink" ControlId="chkEnablePermalink" BindingProperty="Checked"
				UserFieldName="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableWpfMetadataExtraction_Label %>" />
			<tis:wwDataBindingItem ID="WwDataBindingItem9g" runat="server" BindingSource="CoreConfig"
				BindingSourceMember="EnableSlideShow" ControlId="chkEnableSlideShow" BindingProperty="Checked"
				UserFieldName="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableWpfMetadataExtraction_Label %>" />
			<tis:wwDataBindingItem ID="WwDataBindingItem9h" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem8" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem9" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem10" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem11" runat="server" BindingSource="CoreConfig"
			...
			<tis:wwDataBindingItem ID="WwDataBindingItem4b" runat="server" BindingSource="CoreConfig"
	...
	<tis:PopupInfo ID="PopupInfo" runat="server" DialogControlId="dgPopup" DefaultDialogTitleCss="dg5ContentTitleCss"
		...
		<PopupInfoItems>
			...
			<tis:PopupInfoItem ID="PopupInfoItem3b" runat="server" ControlId="chkEnableMetadata"
				DialogTitle="<%$ Resources:GalleryServerPro, Cfg_enableImageMetadata_Hdr %>" DialogBody="<%$ Resources:GalleryServerPro, Cfg_enableImageMetadata_Bdy %>" />
			<tis:PopupInfoItem ID="PopupInfoItem3c" runat="server" ControlId="chkEnableWpfMetadataExtraction"
				DialogTitle="<%$ Resources:GalleryServerPro, Cfg_enableWpfMetadataExtraction_Hdr %>"
				DialogBody="<%$ Resources:GalleryServerPro, Cfg_enableWpfMetadataExtraction_Bdy %>" />
			<tis:PopupInfoItem ID="PopupInfoItem3d" runat="server" ControlId="chkEnableMoDownload"
			...
			<tis:PopupInfoItem ID="PopupInfoItem3e" runat="server" ControlId="chkEnableMoZipDownload"
			...
			<tis:PopupInfoItem ID="PopupInfoItem3f" runat="server" ControlId="chkEnablePermalink"
			...
			<tis:PopupInfoItem ID="PopupInfoItem3g" runat="server" ControlId="chkEnableSlideShow"
