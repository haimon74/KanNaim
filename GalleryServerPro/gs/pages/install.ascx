<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="install.ascx.cs" Inherits="GalleryServerPro.Web.gs.pages.install" %>
	...
	<div id="wizInstall" class="gsp_rounded10">
		...
		<div id="wizCtnt" class="wizCtnt" runat="server">
				...
				<div class="gsp_addleftpadding5">
					...
					<p>
						<asp:RadioButton ID="rbDataProviderSqlServer" runat="server" GroupName="DataProvider"
							Text="SQL Server (2000, 2005, or 2008)" /></p>
				</div>
			...
			<asp:Panel ID="GsAdmin" runat="server" Visible="false">
				...
				<p class="gsp_msgfriendly gsp_addleftpadding6" style="display: <%= (this.ProviderDb == GalleryServerPro.Web.gs.pages.ProviderDataStore.SqlServer ? "block;" : "none;") %>">
			...
			<asp:Panel ID="Finished" runat="server" Visible="false">
				...
				<div>
					...
					<asp:Panel ID="pnlGalleryServerProConfigNeedUpdating" runat="server" Visible="False"
						CssClass="gsp_addtopmargin5">
						<img src="<%= Util.GalleryRoot %>/images/go_14x14.png" alt="" style="width: 14px;
							height: 14px; float: left; padding-top: 0.6em;" />
						<div style="margin-left: 25px;">
							<p>
								<span class="gsp_bold">Galleryserverpro.config: </span>
								<asp:Literal ID="l63" runat="server" Text="<%$ Resources:GalleryServerPro, Installer_Finished_GspCfg_Need_Updating_Dtl %>" />&nbsp;<span
									class="gsp_bold"><%= EncryptionKey%></span>
							</p>
						</div>
					</asp:Panel>
					<p class="gsp_msgfriendly">
