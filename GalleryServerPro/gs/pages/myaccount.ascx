<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="myaccount.ascx.cs" Inherits="GalleryServerPro.Web.gs.pages.myaccount" %>
...
<tis:wwDataBinder ID="wwDataBinder" runat="server">
	<DataBindingItems>
		...
		<tis:wwDataBindingItem ID="wbi8" runat="server" BindingSource="CurrentProfile" BindingSourceMember="EnableUserAlbum"
