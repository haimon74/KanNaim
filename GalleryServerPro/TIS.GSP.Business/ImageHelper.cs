...
namespace GalleryServerPro.Business
{
	...
	public static class ImageHelper
	{
		...
		public static void CalculateThumbnailWidthAndHeight(int originalWidth, int originalHeight, out int newWidth, out int newHeight, bool autoEnlarge)
		{
			int maxLength = GalleryServerPro.Configuration.ConfigManager.GetGalleryServerProConfigSection().Core.MaxThumbnailLength;

			if (!autoEnlarge && (maxLength > originalWidth) && (maxLength > originalHeight))
			{
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1021:AvoidOutParameters", MessageId = "2#"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1021:AvoidOutParameters", MessageId = "1#")]
		public static void CalculateOptimizedWidthAndHeight(System.Drawing.Image bmp, out int width, out int height)
		{
			if (bmp == null)
				throw new ArgumentNullException("bmp");

			// Calculate the width and height based on the user settings and aspect ratio of the specified bitmap.
			int maxLength = GalleryServerPro.Configuration.ConfigManager.GetGalleryServerProConfigSection().Core.MaxOptimizedLength;
