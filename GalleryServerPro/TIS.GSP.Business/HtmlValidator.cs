...
namespace GalleryServerPro.Business
{
	...
	public class HtmlValidator : IHtmlValidator
	{
		...
		private static readonly string[] _allowedHtmlTags = Configuration.ConfigManager.GetGalleryServerProConfigSection().Core.AllowedHtmlTags.ToLowerInvariant().Replace(" ", String.Empty).Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
		private static readonly string[] _allowedHtmlAttributes = Configuration.ConfigManager.GetGalleryServerProConfigSection().Core.AllowedHtmlAttributes.ToLowerInvariant().Replace(" ", String.Empty).Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
		private static readonly bool _allowUserEnteredJavascript = Configuration.ConfigManager.GetGalleryServerProConfigSection().Core.AllowUserEnteredJavascript;
		private static readonly bool _allowHtmlInTitlesAndCaptions = Configuration.ConfigManager.GetGalleryServerProConfigSection().Core.AllowHtmlInTitlesAndCaptions;
		...
		internal HtmlValidator(string html) : this(html, (_allowHtmlInTitlesAndCaptions ? _allowedHtmlTags : null), (_allowHtmlInTitlesAndCaptions ? _allowedHtmlAttributes : null), _allowUserEnteredJavascript) { }
