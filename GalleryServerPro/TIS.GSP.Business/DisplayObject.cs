			...
			set
			{
				...
				if (value != null)
				{
					...
					if (parentAlbum != null)
					{
						...
						string albumOptimizedPath = HelperFunctions.MapAlbumDirectoryStructureToAlternateDirectory(albumOriginalPath, AppSetting.Instance.OptimizedPath);
						string albumThumbnailPath = HelperFunctions.MapAlbumDirectoryStructureToAlternateDirectory(albumOriginalPath, AppSetting.Instance.ThumbnailPath);
				...
				this._mimeType = GalleryServerPro.Business.MimeType.LoadInstanceByFilePath(value.Name);
			...
			get
			{
				if ((this._bitmap == null) && (this.FileInfo != null))
				{
					try
					{
						...
						{
							throw new UnsupportedImageTypeException(this.Parent);
						}
					}
					catch (ArgumentException)
					{
