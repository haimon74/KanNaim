...
namespace GalleryServerPro.Business.Metadata
{
	...
	public class MetadataItem
	{
		...
		private static System.Text.ASCIIEncoding _asciiEncoding = new System.Text.ASCIIEncoding();
		...
		/// <summary>
		/// Gets an enumeration specifying the data type of the values stored in the current <see cref="MetadataItem.PropertyItem"/> property.
		/// Note that these are not ordinary .NET types.
		/// </summary>
		/// <value>The enum value specifying the data type of the values stored in the current <see cref="MetadataItem.PropertyItem"/> property.</value>
		...
		/// <summary>
		/// Gets the value of the current <see cref="MetadataItem.PropertyItem"/>. It is converted from the original byte array to
		...
		private void ExtractPropertyItemValue()
		{
			...
			{
				throw new GalleryServerPro.ErrorHandler.CustomExceptions.BusinessException("The function GalleryServerPro.Business.Metadata.MetadataItem.ExtractPropertyItemValue() must assign a value other than NotDefined to the field _extractedValueType.");
			}
		}
		...
		private string ExtractPropertyValueString(ref ExtractedValueType formattedValueType)
		{
			...
			return _asciiEncoding.GetString(this._propItem.Value);
		}
