...
namespace GalleryServerPro.Business
{
	...
	public class ExternalThumbnailCreator : IDisplayObjectCreator
	{
		...
		public void GenerateAndSaveFile()
		{
			...
			string thumbnailPath = HelperFunctions.MapAlbumDirectoryStructureToAlternateDirectory(((IAlbum)this._galleryObject.Parent).FullPhysicalPath, AppSetting.Instance.ThumbnailPath);
			...
			string newFilename = HelperFunctions.ValidateFileName(thumbnailPath, GenerateNewFilename(imgFormat));
		...
		private static string GenerateNewFilename(ImageFormat imgFormat)
		{
