...
namespace GalleryServerPro.Web.Entity
{
	...
	public class MediaObjectWebEntity
	{
		...
		/// <summary>
		/// The URL for the previous media object.
		/// </summary>
		public string PrevPermalinkUrl;
		/// <summary>
		...
		/// <summary>
		/// The URL for the next media object.
		/// </summary>
		public string NextPermalinkUrl;
		/// <summary>
		...
		/// <summary>
		/// The URL that points to the web page containing the next media object in a slide show.
		/// </summary>
		public string NextSSPermalinkUrl;
		/// <summary>
