<%@ Page Language="C#" MasterPageFile="~/master/taskMstr.master" AutoEventWireup="true"
	Codebehind="rotateimages.aspx.cs" Inherits="GalleryServerPro.Web.task.rotateimages" %>
						...
						<td>
							<div class="hovercontainer">
								<img src="<%# GetThumbnailUrl((IGalleryObject) Container.DataItem) %>" alt="<%# RemoveHtmlTags(Eval("Title").ToString()) %>"
									title="<%# RemoveHtmlTags(Eval("Title").ToString()) %>" class="rotate" style="width: <%# DataBinder.Eval(Container.DataItem, "Thumbnail.Width").ToString() %>px;
