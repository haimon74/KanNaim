<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error_404.aspx.cs" Inherits="GalleryServerPro.Web.error.error_404" %>
...
<body>
	...
	<div id="errContainer">
		...
		<div id="errContent">
			<h2>
				<asp:Literal ID="l2" runat="server" Text="<%$ Resources:GalleryServerPro, Error_404_Hdr %>" /></h2>
			<p>
				<asp:Literal ID="l3" runat="server" Text="<%$ Resources:GalleryServerPro, Error_404_Dtl %>" /></p>
