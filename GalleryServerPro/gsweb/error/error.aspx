<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error.aspx.cs" Inherits="GalleryServerPro.Web.error.error" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>
		<asp:Literal ID="l1" runat="server" Text="<%$ Resources:GalleryServerPro, Error_Page_Title %>" /></title>
	<style type="text/css">
		body { font: 0.9em Verdana, Arial, Helvetica, sans-serif; background-color: #f5f5f5; color: #000; }
		img { border: none; }
		div#errContainer { margin: 25px auto auto auto; width: 600px; height: 500px; border: 3px solid #369; }
		...
		div#errContainer div#errContent { height: 315px; overflow: auto; background-color: #ECECD9; padding: 1em; }
...
<body>
	...
	<div id="errContainer">
		...
		<div id="errContent">
			<h2>
				<asp:Literal ID="l2" runat="server" Text="<%$ Resources:GalleryServerPro, Error_Hdr %>" /></h2>
			<p>
		...
		<div id="errFooter">
			<a href="http://www.techinfosystems.com" title="Go to the Tech Info Systems home page">
				<img src="../images/tis_logo.gif" alt="Tech Info Systems logo" /></a>
		</div>
	</div>
	</form>
</body>
