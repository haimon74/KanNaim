<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error_cannot_write_to_media_object_dir.aspx.cs" Inherits="GalleryServerPro.Web.error.error_cannot_write_to_media_object_dir" %>
...
<body>
	...
	<div id="errContainer">
		...
		<div id="errContent">
			<h2>
				<asp:Literal ID="l2" runat="server" Text="<%$ Resources:GalleryServerPro, Error_Cannot_Write_To_Directory_Hdr %>" /></h2>
			<p>
