...
function Gsp$Progress$abortTask() { 
    PageMethods.TerminateTask(_taskID, this._onFeedbackFailed, this._onFeedbackFailed, this);
}
...
function Gsp$Progress$_checkProgress() {
	...
	PageMethods.GetCurrentStatus(this._onFeedbackReceived, this._onFeedbackFailed, this);
}
