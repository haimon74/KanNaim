...
namespace GalleryServerPro.Business.Metadata
{
	...
	{
		///<summary>Not fired</summary>
		NotFired = 0,
		///<summary>Fired</summary>
		Fired = 1,
		///<summary>Fired but no strobe returned</summary>
		FiredButNoStrobeReturned = 5,
		///<summary>Fired and strobe returned</summary>
	...
	/// <summary>
	/// Specifies the name of the formatted metadata item that a media object may contain. Each item represents
	/// a custom formatted value derived from a System.Windows.Media.Imaging.BitmapMetadata property or one or more 
	/// GDI+ image property tags. (The GDI+ property tags are defined in the <see cref="RawMetadataItemName" /> enumeration.)
	/// </summary>
	public enum FormattedMetadataItemName
	{
		...
		/// ImageHeight. For compressed images such as JPEG, this value is derived from ExifPixYDim. </summary>
		Height,
		...
		IsoSpeed,
		/// <summary>Keywords. Derived from BitmapMetadata.Keywords.</summary>
		Keywords,
		...
		Subject,
		/// <summary>Specifies the title of the image. Derived from BitmapMetadata.Title.</summary>
		Title,
		...
		/// ImageWidth. For compressed images such as JPEG, this value is derived from ExifPixXDim. </summary>
		Width
	}
