...
namespace GalleryServerPro.Business.Interfaces
{
	...
	/// configuration data from the web.config or galleryserverpro.config files.
	/// </summary>
	public interface IBackupFile
	{
		...
		/// gs_GetVersion user-defined function. In SQLite, the version is stored in the table gs_SchemaVersion.
		/// </summary>
