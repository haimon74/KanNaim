...
namespace GalleryServerPro.Business.Interfaces
{
	...
	/// </summary>
	public interface IDisplayObject : IDisposable
  {
		/// <summary>
    ...
    string FileNamePhysicalPath
    {
      get;
		...
		/// <exception>A GalleryServerPro.ErrorHandler.CustomExceptions.InvalidMediaObjectException is thrown if the file 
		...
		/// <exception>A GalleryServerPro.ErrorHandler.CustomExceptions.UnsupportedImageTypeException is thrown when 
		...
		/// <summary>
		/// Gets or sets the HTML that defines an externally stored media object, such as videos hosted at YouTube or Silverlight.live.com. This property
		/// is set only For local
