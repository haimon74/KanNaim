...
namespace Shimanni.Trader.DataStructure
{
    public enum eOrderStatus
    {
        ...
        /// <summary>
        /// MarketData (Added by Omer)
        /// </summary>
        [Description("MarketData")] MarketData,

        
        /// <summary>
        /// Order is queuing not to exceed orders rate per second - This is a shimanni addition
        /// </summary>
        [Description("QueingForCancel")] QueingForCancel,
        /// Order is queuing not to exceed orders rate per second  - This is a shimanni addition
        /// </summary>
        [Description("QueingForSubmit")] QueingForSubmit,
