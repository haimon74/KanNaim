...
{
    /// <summary>
    /// Update PortfolioEntity Event Arguments
    /// </summary>
    [Serializable()]
    public class UpdatePortfolioEventArgs : EventArgs
    {
        ...
        /// The exchange field in a contract is not set for PortfolioEntity update.</param>
        ...
        /// The exchange field in a contract is not set for PortfolioEntity update.
        /// </summary>
