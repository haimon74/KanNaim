...
namespace Shimanni.Trader.BL
{
    public static class OrdersManagement
    {
        ...
        public static List<ShimanniOrderEntity> AllOpenOrdres = new List<ShimanniOrderEntity>();
        ...
        {
            pOrder.ParentAsset.ParentStrategy.printStrategyStateToLog();
            ShimanniOrderID += 1;
            pOrder.ShimanniOrderID = ShimanniOrderID;
            AssetEntity AssetEntity = pOrder.ParentAsset;
            pOrder.Remains = (int)pOrder.SizeAtInitiation;
