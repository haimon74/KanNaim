...
namespace Shimanni.Trader.DataStructure
{
    ...
    {           
        ...
        protected int                                 _ShortAvailableAtBroker;
        ...
        private bool                                _CalculatedPortfolioPostionWasUtpdated;
        protected int                                 _PortfolioPositionAtLastShortUpdate;
        ...
        public AssetEntity(StrategyEntity ParentStrategy)
        {
            ...
            _PortfolioPositionAtLastShortUpdate = int.MaxValue;
            ...
            _ExpiryYear = null;
            _ExpiryMonth = null;
            _CalculatedPortfolioPostionWasUtpdated = false;
        }
        public AssetEntity()
        {
            _SymbolInDataSource = "Enter New Symbol";
        ...
        #region Properties
        [XmlIgnore]
        public abstract int PortfolioPositionAtLastShortUpdate
        {
            get;
            set;
        }
        [XmlIgnore]
        public bool CalculatedPortfolioPostionWasUtpdated
        {
            get { return _CalculatedPortfolioPostionWasUtpdated; }
            set { _CalculatedPortfolioPostionWasUtpdated = value; }
        }
        [XmlIgnore]
        ...
        [XmlIgnore]
        public double HedgingSpreadDollarTerms
        {
            get
            {
                return _HedgingSpreadBP * 0.0001 * MarketData.MidPrice ;
            }
        }
        [XmlIgnore]
        ...
        /// <summary>
        /// ExposuresLatitude in doallar terms translated into  units of asset
        /// </summary>
        [XmlIgnore]
        public int StickySizeLatidude
        {
            get
            {
                return (int)(ParentStrategy.ExposuresLatitude * Math.Abs(this.Beta) / (this.MarketData.MidPrice * this.Multiplayer)); 
            }
        ...
        /// </summary>
        [XmlIgnore]
        public abstract int ShortAvaliableAtBroker
        {
            get; set;
        ...
        public int NetSharesAvelibleForSell
        {
            get {
                    int SAAB;
                    if (ShortAvaliableAtBroker == int.MaxValue)
                       SAAB = 0;
                    else
                        SAAB = ShortAvaliableAtBroker;

                    
                    int x=      Math.Max(ShortAvaliableAtBroker - PortfolioPositionAtLastShortUpdate, 0)  + 
                                PortfolioPositionCalculated - PortfolioPositionAtLastShortUpdate + 
                                Math.Max(PortfolioPositionCalculated , 0)  - 
                                Sell.SumOfAll;
                    if (x > 0)
                        return x;
                    else
        ...
        public eExchangeRoute ExchangeRouteForAddingLiquidityOrder
{
        ...
        /// todo: to make a table of Brokers and exchanges fees
        ...
        /// <summary>
        /// Takes into account the fees of the price to buy
        /// </summary>
        [XmlIgnore]
        ...
        /// <summary>
        /// Takes into account the fees of the price to Sell
        /// </summary>
        [XmlIgnore]
        ...
        /// <summary>
        /// If we are BestAsk than return 0 else reduce from market ask reduced by the sum of open hedging buy order that we sent and await confirmation
        /// </summary>
        [XmlIgnore]
        ...
        /// If we are BestBid than return 0 else reduce from market bid reduced by the sum of open hedging sell orders that we sent and await confirmation
        [XmlIgnore]
