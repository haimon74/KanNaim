...
namespace Krs.Ats.IBNet
{
    ...
    public class IBClient : IDisposable
    {
        ...
        /// <summary>
        /// Called Internally when the receive thread receives an Update PortfolioEntity event.
        /// </summary>
        /// <param name="e">Update PortfolioEntity Event Arguments</param>
        ...
        /// <summary>
        /// Call this method to request market data. The market data will be returned by the tickPrice, tickSize, tickOptionComputation(), tickGeneric(), tickString() and tickEFP() CommonUtils.
        /// </summary>
        ...
        /// <summary>
        /// Call this method to request market depth for a specific contract. The market depth will be returned by the updateMktDepth() and updateMktDepthL2() CommonUtils.
        /// </summary>
        ...
        /// <summary>
        /// Call this function to start getting account values, PortfolioEntity, and last update time information.
        /// </summary>
        /// <param name="subscribe">If set to TRUE, the client will start receiving account and PortfolioEntity updates. If set to FALSE, the client will stop receiving this information.</param>
        /// <param name="acctCode">the account code for which to receive account and PortfolioEntity updates.</param>
