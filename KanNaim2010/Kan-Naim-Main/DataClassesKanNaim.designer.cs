...
namespace Kan_Naim_Main
{
    ...
    partial void InsertTable_Index(Table_Index instance);
    partial void UpdateTable_Index(Table_Index instance);
    partial void DeleteTable_Index(Table_Index instance);
