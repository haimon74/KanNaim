...
{
    public partial class FormArticleRichTextBoxEditorPlusRtfTextDialog : Form
    {
        public FormArticleRichTextBoxEditorPlusRtfTextDialog()
        {
            InitializeComponent();
        }
...
\par
        ...
        {
            if (textBox1.Text == userControlRichTextBoxEditor1.RichTextBox1.Rtf)
                MessageBox.Show("text identical");

            textBox1.Text = userControlRichTextBoxEditor1.RichTextBox1.Rtf;
            //textBox1.Refresh();
        }

        private void Button2Click(object sender, EventArgs e)
        {
            userControlRichTextBoxEditor1.RichTextBox1.Rtf = textBox1.Text;
            //userControlRichTextBoxEditor1.RichTextBox1.Refresh();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string htmlText = userControlRichTextBoxEditor1.ConvertRtfTextToHtmlText();
                //userControlRichTextBoxEditor1.GeneratBaseHtmlString(userControlRichTextBoxEditor1.RichTextBox1.Text);
