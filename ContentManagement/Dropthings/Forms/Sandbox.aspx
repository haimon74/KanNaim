...
<%@ Register src="~//Forms/UserControls/SandboxForm/InputDate.ascx" tagname="InputDate" tagprefix="uc1" %>

<%@ Register src="~//Forms/UserControls/SandboxForm/InputEmail.ascx" tagname="InputEmail" tagprefix="uc2" %>

<%@ Register src="~//Forms/UserControls/SandboxForm/InputZipCode.ascx" tagname="InputZipCode" tagprefix="uc3" %>
<%@ Register src="~//Forms/UserControls/SandboxForm/InputPhoneNumber.ascx" tagname="InputPhoneNumber" tagprefix="uc4" %>
<%@ Register src="~//Forms/UserControls/SandboxForm/InputIdNumber.ascx" tagname="InputIdNumber" tagprefix="uc5" %>
<%@ Register src="~//Forms/UserControls/SandboxForm/InputFullName.ascx" tagname="InputFullName" tagprefix="uc6" %>

<%@ Register src="~//Forms/UserControls/SandboxForm/InputName.ascx" tagname="InputName" tagprefix="uc7" %>

<%@ Register src="~//Forms/UserControls/SandboxForm/InputPassword.ascx" tagname="InputPassword" tagprefix="uc8" %>

<%@ Register src="~//Forms/UserControls/SandboxForm/InputPasswordX2.ascx" tagname="InputPasswordX2" tagprefix="uc9" %>

<%@ Register src="~//Forms/UserControls/StyleManagementForm/InputAsyncFileUpload/InputAsyncFileUpload.ascx" tagname="InputAsyncFileUpload" tagprefix="uc10" %>
...
<body oncopy="return false;" oncontextmenu="return false;" ondoubleclick="return false;" onmousemove="return false;">
    ...
    <div>
        <cc1:TabContainer ID="TabContainerStyle" runat="server" ActiveTabIndex="0" Width="700px">
            ...
            <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="Image">
                <ContentTemplate>
                    <div id="Div1" style="width: auto; direction: rtl; text-align: right;">
