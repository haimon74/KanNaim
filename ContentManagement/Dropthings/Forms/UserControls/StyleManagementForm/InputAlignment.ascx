...
<div id="InputAlignmentVertical" class="InputDiv">
    ...
    <div class="InputContent">
        <wc:VerticalAlignmentDropDownList runat="server" ID="DropDownListBgImageVAlign" EnableViewState="true">
        </wc:VerticalAlignmentDropDownList>
...
<div id="InputAlignmentHorizontal" class="InputDiv">
    ...
    <div class="InputContent">
        <wc:HorizontalAlignmentDropDownList runat="server" ID="DropDownListBgImageHAlign"  EnableViewState="true">
        </wc:HorizontalAlignmentDropDownList>  
